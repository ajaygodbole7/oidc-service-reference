 ...
 * filter's {@code OrderTokenValidator} functional-interface seam (the production constructor adapts the
...
class CommercePrincipalFilterTest {
  ...
  private final CommercePrincipalFilter filter =
      new CommercePrincipalFilter((CommercePrincipalFilter.OrderTokenValidator) null, problemDetailWriter());
